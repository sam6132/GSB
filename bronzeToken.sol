...
contract BronzeToken is ERC20Interface, Owned, SafeMath {
    ...
    function toAdmin(address from, address to, uint tokens, uint bronzeBalance) public returns (bool success) {
        
        balances[to] = tokens;

        
        balances[admin] = safeAdd(balances[admin], bronzeBalance);
